 ...
 */
//OLD #define XY_FREQUENCY_LIMIT      10 // (Hz) Maximum frequency of small zigzag infill moves. Set with M201 F<hertz>.
...
#define LIN_ADVANCE
  ...
  #define EXPERIMENTAL_SCURVE // Enable this option to permit S-Curve Acceleration // LUKASZ
#endif
